...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221020_dukanmarket_570a8bf94c9f23289597_20221020130706_archive.zip';
        const ARCHIVE_SIZE       = '34365570';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '570a8bf-20130706';
        const SECONDARY_PACKAGE_HASH = '0efcb0e-20130706';
        const VERSION            = '1.5.0';
